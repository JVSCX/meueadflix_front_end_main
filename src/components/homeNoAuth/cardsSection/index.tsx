      ...
      <Container className="d-flex flex-wrap justify-content-center gap-4 pb-5">
        <div className={styles.card1}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX FRONT-END é o lugar para você evoluir. Para isso, você
            vai ter acesso às práticas avançadas de programação, atualizações de
        ...
        <div className={styles.card2}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX BACK-END é o lugar para você evoluir. Para isso, você
            vai ter acesso às práticas avançadas de programação, atualizações de
            tecnologias e todo o suporte técnico necessário para ser um sênior
            na programação.
          </p>
        ...
        <div className={styles.card3}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX MOBILE é o lugar para você evoluir. Para isso, você vai
        ...
        <div className={styles.card4}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX GIT e GITHUB é o lugar para você evoluir. Para isso,
        ...
        <div className={styles.card5}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX PROJETOS é o lugar para você evoluir. Para isso, você
            vai ter acesso às práticas avançadas de programação, atualizações de
            tecnologias e todo o suporte técnico necessário para ser um sênior
            na programação.
          </p>
        ...
        <div className={styles.card6}>
          ...
          <p className={styles.cardDescription}>
            O MEUEADFLIX CARREIRA é o lugar para você evoluir. Para isso, você
            vai ter acesso às práticas avançadas de programação, atualizações de
            tecnologias e todo o suporte técnico necessário para ser um sênior
            na programação.
          </p>
